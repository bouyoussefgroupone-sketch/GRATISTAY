  ...
  return (
    <article className="overflow-hidden rounded-3xl border border-[var(--line)] bg-[var(--surface)] shadow-sm">
      <div className="relative h-56">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[rgba(15,23,40,0.6)] via-transparent to-transparent" />
      ...
      <div className="space-y-4 p-5">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="rounded-xl bg-[var(--brand-700)] px-2.5 py-2 text-center text-white">
        ...
        <div className="flex gap-3">
          ...
          <Link
            ...
            className="inline-flex flex-1 items-center justify-center rounded-xl bg-[var(--brand-700)] px-4 py-3 text-sm font-semibold text-white transition hover:bg-[var(--brand-600)]"
          >
            Choisir
          </Link>
        </div>
