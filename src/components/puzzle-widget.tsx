  ...
  return (
    <div className="rounded-[28px] border border-[var(--line)] bg-[var(--surface-muted)] p-4">
      <div className="flex items-center justify-between">
        <div>
          <div className="text-sm font-semibold text-[var(--ink-950)]">Photo hotel</div>
          <div className="mt-1 text-xs text-[var(--ink-600)]">Revelation de haut en bas</div>
        </div>
      ...
      <div className="relative mt-4 overflow-hidden rounded-[26px] border border-white/60 bg-[var(--surface-strong)] shadow-[inset_0_1px_0_rgba(255,255,255,0.6)]">
        <div
          className="aspect-square w-full scale-[1.06] bg-cover bg-center blur-md"
          style={{ backgroundImage: `url(${imageUrl})` }}
        />
        <div className="absolute inset-0 bg-[rgba(10,18,30,0.36)]" />
        ...
        >
          <div className="h-1 bg-white/92 shadow-[0_0_18px_rgba(255,255,255,0.85)]" />
        </div>

        <div className="pointer-events-none absolute inset-x-4 bottom-4 rounded-2xl bg-[var(--overlay-dark)] px-4 py-3 text-white backdrop-blur-sm">
